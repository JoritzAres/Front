...
function ProximosEventos() {
  ...
  const handleCrearEvento = async () => {
    try {
      ...
      console.log("Ruta creado con éxito", respuesta);
      limpiarCampos();
  ...
  const confirmarEliminacion = () => {
    if (eventoSeleccionado) {
      ...
      if (fechaEvento < fechaActual) {
        setMensajeError("No puedes eliminar una ruta que ya ha pasado.");
        ...
        setMensajeError("No tienes permiso para eliminar esta ruta.");
        setDialogoErrorAbierto(true);
      }
    } else {
      setMensajeError("Por favor selecciona una ruta para eliminar.");
      setDialogoErrorAbierto(true);
    }
  };
  useEffect(() => {
    const fetchEventos = async () => {
      try {
        const response = await LeerRutas();
  ...
  const handleActualizarEvento = async () => {
    try {
      ...
      if (
        ...
        setMensajeError("La fecha máxima debe ser anterior a la fecha de la ruta.");
        setDialogoErrorAbierto(true);
        return;
      }
      if (
        ...
        setMensajeError("No tienes permisos para editar esta ruta.");
        setDialogoErrorAbierto(true);
        return;
      }
      ...
      setMensajeError("Error al actualizar la ruta:", error);
      setDialogoErrorAbierto(true);
    }
  };
    ...
    <ThemeProvider theme={theme}>
      <Box style={{ height: "100%", width: "100%" }}>
        ...
        <Container component="main" sx={{ mt: 4, mb: 4 }}>
          {/* <Button style={{ backgroundColor: "grey", color: "white", width: "20%", padding: "10px", marginTop: "5%", marginRight: "5%" }} onClick={() => cambiarVista("verEventos")}>Ver Rutas</Button> */}
          {/* <Button style={{ backgroundColor: "grey", color: "white", width: "20%", padding: "10px", marginTop: "5%", marginLeft: "5%" }} onClick={() => cambiarVista("crearEvento")}>Crear Rutas</Button> */}
              ...
              <Container component="main" sx={{ mb: 4 }}>
                ...
                <Dialog
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogContentText>
                        Edita los campos de la ruta seleccionado.
                      </DialogContentText>
                      <TextField
                        autoFocus
                        margin="dense"
                  ...
                  <TableContainer component={Paper} sx={{ overflowX: "auto" }}>
                    <Table aria-label="tabla de próximas Rutas">
                      <TableHead>
